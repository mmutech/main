<div class="content container-fluid">
    ...
    {{-- User Info to be converted into a partial component --}}
    <div class="card mb-0">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-striped custom-table mb-0 datatable dataTable no-footer"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-sort="ascending"
                                                    aria-label="Asset User: activate to sort column descending"
                                                    style="width: 129.703px;">Asset User</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Asset Name: activate to sort column ascending"
                                                    style="width: 160.25px;">Asset Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Asset Id: activate to sort column ascending"
                                                    style="width: 77.7969px;">Asset Id</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Purchase Date: activate to sort column ascending"
                                                    style="width: 101.562px;">Purchase Date</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Warrenty: activate to sort column ascending"
                                                    style="width: 67.4844px;">Warrenty</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Warrenty End: activate to sort column ascending"
                                                    style="width: 98.2031px;">Warrenty End</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Amount: activate to sort column ascending"
                                                    style="width: 56.9531px;">Amount</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                <td class="sorting_1">Bernardo Galaviz</td>
                                                <td>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="#"
                                                                data-bs-toggle="modal" data-bs-target="#edit_asset"><i
                                                                    class="fa fa-pencil m-r-5"></i> Edit</a>
                                                            <a class="dropdown-item" href="#"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#delete_asset"><i
                                            ...
                                            <tr class="even">
                                                <td class="sorting_1">Catherine Manseau</td>
                                                <td>
                                            ...
                                            <tr class="odd">
                                                <td class="sorting_1">Jeffery Lalor</td>
                                                <td>
                                                    <strong>Canon Portable Printer</strong>
                                                </td>
                                                <td>#AST-0009</td>
                                            ...
                                            <tr class="even">
                                                <td class="sorting_1">Jeffrey Warden</td>
                                                <td>
                                                    <strong>Canon Portable Printer</strong>
                                                </td>
                                                <td>#AST-0006</td>
                                            ...
                                            <tr class="odd">
                                                <td class="sorting_1">Lesley Grauer</td>
                                                <td>
                                                    <strong>Seagate Harddisk</strong>
                                                </td>
                                                <td>#AST-0008</td>
                                            ...
                                            <tr class="even">
                                                <td class="sorting_1">Loren Gatlin</td>
                                                <td>
                                                    <strong>Dell Laptop</strong>
                                                </td>
                                                <td>#AST-0010</td>
                                            ...
                                            <tr class="odd">
                                                <td class="sorting_1">Mike Litorus</td>
                                                <td>
                                                    <strong>Dell Laptop</strong>
                                                </td>
                                                <td>#AST-0004</td>
                                            ...
                                            <tr class="even">
                                                <td class="sorting_1">Richard Miles</td>
                                                <td>
                                                    <strong>Dell Laptop</strong>
                                                </td>
                                                <td>#AST-0001</td>
