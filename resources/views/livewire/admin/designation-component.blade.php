        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto float-end ms-auto">
                <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                    data-bs-target="#add_designation"><i class="fa fa-plus"></i> Add Designation</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                    ...
                    <tbody>
                        @foreach ($designation as $div)
                            <tr>
                                ...
                                @endif
                                <td class="text-end">
                                    <a @click="editModal = true" class="btn btn-primary" data-bs-toggle="editdesignationForm"
                                        data-bs-target="#edit_designation" wire:click="edit({{$div->id}})"><i class="fa fa-pencil m-r-5"></i></a>
                                    
                                    {{-- <a class="btn btn-danger" style="color:white" href="#" data-bs-toggle="modal"
                                        data-bs-target="#delete_designation" wire:click="remove({{$div->id}})"><i class="fa fa-trash-o m-r-5"></i>
                                        </a> --}}
                                </td>
                            </tr>
                        @endforeach
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h5 class="text-lg">Add Designation</h5>
                        </div>
                            ...
                            <form wire:submit.prevent="createDesignation">
                                <div class="row">
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <button wire:loading wire:target="createDesignation"
    ...
    <div x-show="editModal" x-transition:enter="transition ease-out duration-150"
        ...
        <div class="w-full border-4 border-red-500">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="text-lg">Edit Designation</h5>
                    </div>
                    <div class="modal-body">
                        <form wire:submit.prevent="updateDesignation">
                            <div class="row">
                                ...
                                <div class="submit-section">
                                    ...
                                    <button wire:loading wire:target="updateDesignation"
