<div x-data="{ addModal: @entangle('addModal').defer }">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Grade Level</h3>
                <ul class="breadcrumb">
            ...
            <div class="col-auto float-end ms-auto">
                <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                    data-bs-target="#add_gradeLevel"><i class="fa fa-plus"></i> Add Grade Level</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table mb-0 datatable">
                    ...
                    <tbody>
                        @foreach ($gradeLevel as $div)
                            <tr>
                                <td>#</td>
                                <td>{{$div->designationId}}</td>
                                <td>{{$div->description}}</td>
                                <td>&#8358;{{number_format($div->monthly_gross)}}</td>
                                <td>&#8358;{{number_format($div->monthly_gross * 12)}}</td>
                                <td>{{$div->comment}}</td>
                                ...
                                @endif
                                <td class="text-end">
                                    <a @click="editModal = true" class="btn btn-primary" data-bs-toggle="editGrade LevelForm"
                                        data-bs-target="#edit_Grade Level" wire:click="edit({{$div->id}})"><i class="fa fa-pencil m-r-5"></i></a>
                                    
                                    {{-- <a class="btn btn-danger" style="color:white" href="#" data-bs-toggle="modal"
                                        data-bs-target="#delete_Grade Level" wire:click="remove({{$div->id}})"><i class="fa fa-trash-o m-r-5"></i>
                                        </a> --}}
                                </td>
                            </tr>
                        @endforeach
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h5 class="text-lg">Add Grade Level</h5>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer="designationId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="">Select...</option>
                                                @foreach($designationId as $dept)
                                                    <option value="{{$dept->id}}">{{$dept->description}}</option>
                                                @endforeach
                                              </select>
                                                @error('designationId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                        </div>                                   
                                    </div>  
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Monthly Gross</label>
                                            <input wire:model.defer="monthly_gross"
                                                class="border-gray-300 rounded-sm form-control" type="number">
                                                @error('monthly_gross') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                        </div>
                                    </div>  
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <button wire:loading wire:target="createGradeLevel"
    ...
    <div x-show="editModal" x-transition:enter="transition ease-out duration-150"
        ...
        <div class="w-full border-4 border-red-500">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="text-lg">Edit Grade Level</h5>
                    </div>
                    <div class="modal-body">
                        <form wire:submit.prevent="updateGradeLevel">
                            <div class="row">
                                ...
                                <div class="submit-section">
                                    ...
                                    <button wire:loading wire:target="updateGradeLevel"
