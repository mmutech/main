                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            ...
                            <li class="nav-item"><a href="#bank_statutory" data-bs-toggle="tab" class="nav-link"><i
                                        class="text-info">Click the pen icon () to edit contents of each card</i> <small
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Personal Information <a href="#" class="edit-icon"
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Emergency <a href="#" class="edit-icon"
                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title">Deployment <a href="#" class="edit-icon"
                                        data-bs-toggle="modal" data-bs-target="#deployment_modal"><i
                                            class="fa fa-pencil"></i></a></h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-1-vjx6" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-3-ej52">Select salary basis type
                                                </option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-2-fsgl"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-kbt4-container"
                                                        aria-controls="select2-kbt4-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-kbt4-container" role="textbox"
                                                            aria-readonly="true"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-4-ixkb" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-6-6rey">Select payment type
                                                </option>
                                                <option>Bank transfer</option>
                                                <option>Check</option>
                                                <option>Cash</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-5-t8vc"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-hclc-container"
                                                        aria-controls="select2-hclc-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-hclc-container" role="textbox"
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-7-mu8i" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-9-jf09">Select PF contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-8-pjrx"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-km96-container"
                                                        aria-controls="select2-km96-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-km96-container" role="textbox"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">PF No. <span
                                                    class="text-danger">*</span></label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-10-hueu" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-12-5c72">Select PF contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-11-fe3k"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-zqpg-container"
                                                        aria-controls="select2-zqpg-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-zqpg-container" role="textbox"
                                                            aria-readonly="true" title="Select PF contribution">Select
                                                            PF contribution</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-13-94i8" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-15-ttcs">Select PF contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-14-57xx"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-8alu-container"
                                                        aria-controls="select2-8alu-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-8alu-container" role="textbox"
                                                            aria-readonly="true" title="Select PF contribution">Select
                                                            PF contribution</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Additional rate <span
                                                    class="text-danger">*</span></label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-16-2vl0" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-18-r1io">Select additional rate
                                                </option>
                                                <option>0%</option>
                                                <option>1%</option>
                                                <option>2%</option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-17-43v0"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-u5ff-container"
                                                        aria-controls="select2-u5ff-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-u5ff-container" role="textbox"
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Employee PF rate</label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-19-tofj" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-21-nrqv">Select PF contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-20-6999"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-pe3u-container"
                                                        aria-controls="select2-pe3u-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-pe3u-container" role="textbox"
                                                            aria-readonly="true" title="Select PF contribution">Select
                                                            PF contribution</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Additional rate <span
                                                    class="text-danger">*</span></label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-22-i2hy" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-24-9jmf">Select additional rate
                                                </option>
                                                <option>0%</option>
                                                <option>1%</option>
                                                <option>2%</option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-23-nnss"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-2qlx-container"
                                                        aria-controls="select2-2qlx-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-2qlx-container" role="textbox"
                                                            aria-readonly="true" title="Select additional rate">Select
                                                            additional rate</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-25-no31" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-27-1gjp">Select ESI contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-26-mpma"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-03f3-container"
                                                        aria-controls="select2-03f3-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-03f3-container" role="textbox"
                                                            aria-readonly="true"
                                                            title="Select ESI contribution">Select ESI
                                                            contribution</span><span class="select2-selection__arrow"
                                                            role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">ESI No. <span
                                                    class="text-danger">*</span></label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-28-cpe0" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-30-92nq">Select ESI contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-29-cf1e"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-6zap-container"
                                                        aria-controls="select2-6zap-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-6zap-container" role="textbox"
                                                            aria-readonly="true"
                                                            title="Select ESI contribution">Select ESI
                                                            contribution</span><span class="select2-selection__arrow"
                                                            role="presentation"><b
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-31-uwsj" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-33-6rfe">Select ESI contribution
                                                </option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-32-frlt"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-i87r-container"
                                                        aria-controls="select2-i87r-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-i87r-container" role="textbox"
                                                            aria-readonly="true"
                                                            title="Select ESI contribution">Select ESI
                                                            contribution</span><span class="select2-selection__arrow"
                                                            role="presentation"><b
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-form-label">Additional rate <span
                                                    class="text-danger">*</span></label>
                                            <select class="select select2-hidden-accessible"
                                                data-select2-id="select2-data-34-a4qp" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-36-6kxe">Select additional rate
                                                </option>
                                                <option>0%</option>
                                                <option>1%</option>
                                                <option>2%</option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-35-2a0u"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-ovqr-container"
                                                        aria-controls="select2-ovqr-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-ovqr-container" role="textbox"
                                                            aria-readonly="true"
                                                            title="Select additional rate">Select additional
                                                            rate</span><span class="select2-selection__arrow"
                                                            role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form wire:submit.prevent="saveEducation">
                                    ...
                                    <input type="hidden" wire:model.defer="employee_id"
                                        wire:change="$emit('educations')" id="education_eid" />

                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Institution</label>
                                                <input wire:model.defer="education_institution"
                                                    wire:change="$emit('educations')" id="education_institution"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="border-gray-300 rounded-sm form-control"
                                                    id="education_from" wire:model.defer="education_from"
                                                    type="date">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="border-gray-300 rounded-sm form-control"
                                                    id="education_to" wire:model.defer="education_to"
                                                    type="date">
                                    ...
                                    <div class="submit-section">
                                        <button wire:loading.remove class="btn btn-primary submit-btn">Submit</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form wire:submit.prevent="saveQualification">
                                    ...
                                    <input type="hidden" readonly wire:model.defer="employee_id"
                                        id="qualification_eid" />
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Institution</label>
                                                <input wire:model.defer="qualification_institition"
                                                    id="qualification_institition"
                                                    class="border-gray-300 rounded-sm form-control" type="text">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input wire:model.defer="qualification_certification"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="border-gray-300 rounded-sm form-control"
                                                    id="qualification_date" wire:model.defer="qualification_date"
                                                    type="date">
