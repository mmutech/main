            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                        data-bs-target="#add_division"><i class="fa fa-plus"></i> Add Location</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                        ...
                        <tbody>
                            @foreach ($location as $div)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-end">
                                        <a @click="editModal = true" class="btn btn-primary" data-bs-toggle="editLocationForm"
                                            data-bs-target="#edit_location" wire:click="edit({{$div->id}})"><i class="fa fa-pencil m-r-5"></i></a>
                                ...
                                <form wire:submit.prevent="createlocation">
                                    <div class="row">
                                        ...
                                        <div class="submit-section">
                                            ...
                                            <button wire:loading wire:target="createlocation"
        ...
        <div x-show="editModal" x-transition:enter="transition ease-out duration-150"
            ...
            <div class="w-full border-4 border-red-500">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h5 class="text-lg">Edit Location</h5>
                        </div>
                        <div class="modal-body">
                            <form wire:submit.prevent="updatelocation">
                                <div class="row">
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <button wire:loading wire:target="updatelocation"
