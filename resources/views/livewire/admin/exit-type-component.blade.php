<div x-data="{ addModal: @entangle('addModal').defer }">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Exit Type</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="admin-dashboard.html">Dashboard</a></li>
                    <li class="breadcrumb-item active">Exit Type List</li>
                </ul>
            </div>
            <div class="col-auto float-end ms-auto">
                <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                    data-bs-target="#add_exitType"><i class="fa fa-plus"></i> Add Exit Type</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                    ...
                    <tbody>
                        @foreach ($exitType as $div)
                            <tr>
                                ...
                                @endif
                                <td class="text-end">
                                    <a @click="editModal = true" class="btn btn-primary" data-bs-toggle="editExit TypeForm"
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h5 class="text-lg">Add Exit Type</h5>
                        </div>
                        <div class="modal-body">
                            <form wire:submit.prevent="createExitType">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Exit Type Name</label>
                                            <input wire:model.defer="exit_type"
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <button wire:loading wire:target="createExitType"
    ...
    <div x-show="editModal" x-transition:enter="transition ease-out duration-150"
        ...
        <div class="w-full border-4 border-red-500">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="text-lg">Edit Exit Type</h5>
                    </div>
                    <div class="modal-body">
                        <form wire:submit.prevent="updateExitType">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Exit Type Name</label>
                                ...
                                <div class="submit-section">
                                    ...
                                    <button wire:loading wire:target="updateExitType"
