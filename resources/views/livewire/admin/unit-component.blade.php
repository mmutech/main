        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto float-end ms-auto">
                <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                    data-bs-target="#add_unit"><i class="fa fa-plus"></i> Add Unit</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                    ...
                    <tbody>
                        @foreach ($unit as $div)
                            <tr>
                                ...
                                @endif
                                <td class="text-end">
                                    <a @click="editModal = true" class="btn btn-primary" data-bs-toggle="editunitForm"
                                        data-bs-target="#edit_unit" wire:click="edit({{$div->id}})"><i class="fa fa-pencil m-r-5"></i></a>
                                    
                                    {{-- <a class="btn btn-danger" style="color:white" href="#" data-bs-toggle="modal"
                                        data-bs-target="#delete_unit" wire:click="remove({{$div->id}})"><i class="fa fa-trash-o m-r-5"></i>
                                        </a> --}}
                                </td>
                            </tr>
                        @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer="departmentId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <div class="submit-section">
                                        ...
                                        <button wire:loading wire:target="createUnit"
                        ...
                        <form wire:submit.prevent="updateUnit">
                            <div class="row">
                                ...
                                <div class="submit-section">
                                    ...
                                    <button wire:loading wire:target="updateUnit"
