<div x-data="{ addModal: @entangle('addModal').defer }">
    <div x-data="{ editModal: @entangle('editModal').defer }">
        @push('dashboard-css')
        <!-- Fontawesome CSS -->
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Exit Interview Question</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-dashboard.html">Dashboard</a></li>
                        <li class="breadcrumb-item active">Exit Interview Question List</li>
                    </ul>
                </div>
                <div class="col-auto float-end ms-auto">
                    <a @click="addModal = true" class="btn add-btn" data-bs-toggle="modal"
                        data-bs-target="#add_exitInt"><i class="fa fa-plus"></i> Add Exit Interview Question</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                            ...
                            @foreach ($exitInt as $div)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        {{-- <a class="btn btn-primary" href="{{ url('exit-interview-component', $div->id) }}"><i class="fa fa-eye m-r-5"></i></a> --}}
                 ...
                 <div class="modal-dialog modal-md" role="document">
                     <div class="modal-content">
                         <div class="modal-header ">
                             <h5 class="text-lg">Add Exit Interview Question</h5>
                         </div>
                         <div class="modal-body">
                             <form wire:submit.prevent="createExitInterview">
                                 <div class="row">
                                     <div class="col-md-12">
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Exit Interview Question</label>
                                            <input wire:model.defer="question"
                                     ...
                                     <div class="submit-section">
                                         ...
                                         <button wire:loading wire:target="createExitInterview"
      ...
      <div x-show="editModal" x-transition:enter="transition ease-out duration-150"
          ...
          <div class="w-full border-4 border-red-500">
              <div class="modal-dialog modal-md" role="document">
                  <div class="modal-content">
                      <div class="modal-header ">
                          <h5 class="text-lg">Update Exit Interview Question</h5>
                      </div>
                      <div class="modal-body">
                          <form wire:submit.prevent="updateExitInterview">
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="form-group">
                                          <label>Exit Type Name</label>
                                 ...
                                 <div class="col-md-12">
                                  ...
                                  <div class="submit-section">
                                      ...
                                      <button wire:loading wire:target="updateExitInterview"
